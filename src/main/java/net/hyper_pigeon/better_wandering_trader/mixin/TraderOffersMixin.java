...
public class TraderOffersMixin {
    ...
    static {
        ...
        WANDERING_TRADER_TRADES = copyToFastUtilMap(ImmutableMap.of(1, new TradeOffers.Factory[]{
                ...
                new TraderOffersMixin.SellItemFactory(Items.FIREWORK_ROCKET, 2, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.ACACIA_SAPLING, 1, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.DARK_OAK_SAPLING, 6, 1, 12,1),
                new TraderOffersMixin.SellItemFactory(Items.NAUTILUS_SHELL, 5, 1, 5,1),
                new TraderOffersMixin.SellItemFactory(Items.PUMPKIN_SEEDS, 1, 1, 12,1),
                new TraderOffersMixin.SellItemFactory(Items.MELON_SEEDS, 1, 1, 12,1),
                new TraderOffersMixin.SellItemFactory(Items.SLIME_BALL, 2, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.HONEY_BOTTLE, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.HAY_BLOCK, 1, 1, 8,1),
                ...
                new TraderOffersMixin.SellItemFactory(Items.ZOMBIE_HEAD, 8, 1, 1,1),
                new TraderOffersMixin.SellItemFactory(Items.ENDER_PEARL, 6, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.GUNPOWDER, 1, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.SEA_PICKLE, 2, 1, 5,1),
                new TraderOffersMixin.SellItemFactory(Items.PODZOL, 3, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.MYCELIUM, 3, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.BLAZE_ROD, 5, 1, 3,1),
                new TraderOffersMixin.SellItemFactory(Items.CACTUS, 1, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.BRAIN_CORAL_BLOCK, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.BUBBLE_CORAL_BLOCK, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.FIRE_CORAL_BLOCK, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.HORN_CORAL_BLOCK, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.TUBE_CORAL_BLOCK, 3, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.PACKED_ICE, 3, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.BLUE_ICE, 2, 1, 16,1),
                new TraderOffersMixin.SellItemFactory(Items.PUFFERFISH_BUCKET, 4, 1, 4,1),
                new TraderOffersMixin.SellItemFactory(Items.TROPICAL_FISH_BUCKET, 4, 1, 4,1),
                new TraderOffersMixin.SellItemFactory(Items.SWEET_BERRIES, 2, 1, 8,1),
                new TraderOffersMixin.SellItemFactory(Items.BAMBOO, 2, 1, 12,1),
                new TraderOffersMixin.SellItemFactory(Items.TERRACOTTA, 1, 1, 32,1),
                new TraderOffersMixin.SellItemFactory(Items.PRISMARINE, 4, 1, 8,1)}, 2,
                new TradeOffers.Factory[]{new TraderOffersMixin.SellItemFactory(Items.ENCHANTED_GOLDEN_APPLE, 56, 1, 2,1),
                        new TraderOffersMixin.SellItemFactory(Items.TOTEM_OF_UNDYING,  56, 1, 2,1),
